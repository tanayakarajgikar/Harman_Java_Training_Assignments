...
public class DemoTester {
	...
	public static void main(String[] args) {
		...
		Employee employee2 = new Employee("virat");

		Employee employee3 = new Employee("sai");
		Employee employee4 = new Employee("akhila");

		Employee employee7 = new Employee("alams");
		Employee employee8 = new Employee("aishwarya");
